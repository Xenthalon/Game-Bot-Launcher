...
namespace GameLauncher
{
    class InputOperations
    {
        ...
        [DllImport("user32.dll")]
        public static extern bool ClientToScreen(IntPtr hWnd, ref MousePoint point);

        [DllImport("user32.dll", SetLastError = true)]
        private static extern uint SendInput(uint numberOfInputs, [MarshalAs(UnmanagedType.LPArray), In] INPUT[] inputs, int sizeOfInputStructure);
        ...
        public static Rectangle GetWindowRectangle(IntPtr handle)
        {
            ...
            {
                Console.WriteLine("Couldn't find game window!");
